    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div class="grid gap-6 sm:grid-cols-2 md:grid-cols-5">
            <div class="col-span-5 md:col-span-4">
                <!-- Grid -->
                <div class="grid grid-flow-col auto-cols-auto gap-6 sm:grid-cols-2 lg:grid-cols-8">

                    {{-- @forelse ($this->products as $product ) --}}

                    <!-- Card -->
                    <div wire:key="card-product-"
                        class="flex flex-col mb-4 col-span-4 md:col-span-2">

                        <a class="px-5 py-5 border rounded-xl shadow-sm border-neutral-300 bg-neutral-200 dark:bg-neutral-900 dark:border-neutral-700 dark:shadow-neutral-700/70"
                            href="#!">
                            <div class="p-4 md:p-0 mb-4">
                                ...
                                <h4 class="text-medium font-bold text-gray-800 dark:text-white py-1.5">
                                    {{-- {{ $product->prod_name }} --}}
                                ...
                                <div class="flex flex-row justify-between align-middle items-center">
                                    {{-- <livewire:shop-partials.product-rating :product="$product" wire:key="card-product-{{ $product->id . '' . $product->prod_sku }}" /> --}}
                                </div>
                                <!-- END OF RATING -->
                ...
                <div class="flex flex-col flex-[1_0_0%]">
                    ...
                    <div class="p-4 flex-1 md:p-5 border-b border-gray-200 dark:border-neutral-700">
                        ...
                        <div class="flex flex-col gap-y-4 mt-5 md:mt-7">
                            ...
                            <div wire:key="category-{{ $category->id }}" class="flex">
                                <input type="checkbox" wire:model.live="selectedCategories" value="{{ $category->id }}"
                                    ...
                                    id="hs-checkbox-group-{{ $category->id }} category-{{ $category->id }}">
                                <label for="hs-checkbox-group-{{ $category->id }} category-{{ $category->id }}"
                                    class="text-sm text-gray-500 ms-3 dark:text-neutral-400">{{ $category->prod_cat_name
                                    }}
                    ...
                    <div class="p-4 flex-1 md:p-5 border-b border-gray-200 dark:border-neutral-700">
                        ...
                        <div class="flex flex-col gap-y-4 mt-5 md:mt-7">
                            ...
                            {{-- @empty
                            <div>
                                <p class="text-sm text-gray-500 dark:text-neutral-400">{{ __('No Brands Found') }}</p>
                            </div>
                            @endforelse --}}
